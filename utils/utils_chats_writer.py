...
async def add_new_chat(user_id, chat_title: str, chat_text: List[str] | str, gpt_model: GPTModel):
    ...
    new_chat = Chat(new_chat_id, title=chat_title, text=chat_text, gpt_model=gpt_model)
